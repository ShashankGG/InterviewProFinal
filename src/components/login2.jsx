          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              <div className="flex justify-between ">
                ...
                <a
                  href="#"
                  class="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600"
                >
                  <div class="px-4 py-2">
                    <img
                      class="w-6 h-6"
