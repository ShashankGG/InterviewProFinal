        ...
        <>
            ...
            <div className="ml-[12rem] m-10 grid grid-cols-1 gap-10 lg:grid-cols-2 lg:gap-0">
                ...
                <div className="plan2 w-[35rem]">
                    <div className="log-content">
                        <div>
                            <p className="plan-type mt-[4rem]">Pair <br></br> Programming</p>
                            {/* <p className="login-desc">Basic Plan</p> */}
                        </div>
                        <div className="features1 ">
                            <p className="f text-center text-2xl text-[#032D6C] mt-[4rem] ml-[3rem] mr-[3rem]">
                                Elevate collaboration with pair programming, leveraging expertise for efficient problem-solving and code development, enhancing project outcomes and team synergy
                            </p>
                        </div>
                    </div>
                </div>
