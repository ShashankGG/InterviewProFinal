  ...
  return (
    <section>
      <div className="pl-[36rem] pr-[36rem] bg-white">
        <h3 className="ml-4 font-bold text-2xl mt-[3rem] mb-4 text-[#043C90]">
          Add Candidate
        </h3>
        <hr></hr>

        <h4 className="m-4 font-bold text-xl  text-[#043C90]">
          Candidate Name
        </h4>
        ...
        <h4 className="m-4 font-bold text-xl text-center text-[#043C90]">
          OR
        </h4>

        <h4 className="ml-4 mb-4 font-bold text-xl  text-[#043C90]">
          Add Candidate in bulk
        </h4>

        <label for="dropzone-file" class="flex flex-col items-center w-full max-w-lg p-5 mx-auto mt-2 mb-4 text-center bg-white border-2 border-gray-300 border-dashed cursor-pointer dark:bg-[#d9dadd] dark:border-gray-700 rounded-xl shadow-sm transition hover:shadow-lg">
        ...
        <button class="ml-[19rem] mt-2 mb-6 px-14 py-3 font-medium tracking-wide text-xl text-white capitalize transition-colors duration-300 transform bg-[#191064] rounded-full hover:bg-gray-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
          Done
        </button>
      </div>
    </section>
