  ...
  return (
    <section>
      <div className="pl-[36rem] pr-[36rem] bg-white">
        ...
        <button class="ml-[15rem] mt-6 px-14 py-3 font-medium tracking-wide text-xl text-white capitalize transition-colors duration-300 transform bg-[#191064] rounded-full hover:bg-gray-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80"onClick={()=>navigate("/reqinterview2")}>
                            Next
        </button>
