    ...
    <section>
      <div className="bg-white ">
        ...
        {/* <div className="flex justify-center">
          <button
            class="mt-4 px-10 py-2 font-medium tracking-wide text-xl text-white capitalize transition-colors duration-300 transform bg-[#191064] rounded-full hover:bg-gray-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80"
            onClick={() => navigate("/reqinterview2")}
          >
            Next
          </button>
        </div> */}
