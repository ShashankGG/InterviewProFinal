      ...
      <section id="login-choose">
        ...
        <div className="plans">
          <div className="plan1">
            ...
            <Link to="/login1" className="primary logbutton  mb-[3rem]">
              Login
            </Link>
          </div>
          <div className="plan1">
            ...
            <Link to="/login2" className="primary logbutton mb-[3rem]">
              Login
            </Link>
          </div>
          <div className="plan1">
            ...
            <Link to="/login3" className="primary logbutton mb-[3rem]">
              Login
            </Link>
          </div>
        </div>
